...
if (!$koneksi) { //cek koneksi ke database php my admin
...
if (isset($_POST['simpan'])) { //untuk create form mahasiswa
    $nim        = $_POST['nim'];
    $nama       = $_POST['nama'];
    $alamat     = $_POST['alamat'];
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if ($op == 'edit') { //untuk update form mahasiswa
    ...
    <div class="mx-auto">
        ...
        <div class="card">
            <div class="card-header">
                FORM DATA MAHASISWA UG <p>&copy; 2023 by Flamelia</p>
            </div>
            <div class="card-body">
                <?php
                if ($error) {
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="fakultas" id="fakultas">
                                ...
                                <option value="Sipil Perencanaan" <?php if ($fakultas == "Sipil Perencanaan") echo "selected" ?>>Sipil Perencanaan</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <!-- untuk mengeluarkan (delete) data -->
        <div class="card">
